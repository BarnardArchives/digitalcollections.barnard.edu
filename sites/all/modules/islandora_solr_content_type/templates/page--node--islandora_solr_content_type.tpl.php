...
<div id="page">
  ...
  <header class="header" id="header" role="banner">
    ...
    <?php if ($logo): ?>
      <a href="http://barnard.edu" title="Barnard College" class="header__logo"
         id="logo"><img
    ...
    <?php if ($secondary_menu && !empty($secondary_menu_heading)): ?>
      <nav class="header__secondary-menu" id="secondary-menu" role="navigation">
        <?php print theme('links__system_secondary_menu', array(
          'links' => $secondary_menu, 'attributes' => array(
            'class' => array(
              'links', 'inline', 'clearfix',
            ),
          ), 'heading' => array(
            'text' => $secondary_menu_heading, 'level' => 'h2',
    ...
    <?php if ($main_menu): ?>
      <nav id="main-menu" role="navigation" tabindex="-1">
        ...
        print theme('links__system_main_menu', array(
          'links' => $main_menu, 'attributes' => array(
            'class' => array(
              'links', 'inline', 'clearfix',
            ),
          ), 'heading' => array(
            'text' => t('Main menu'), 'level' => 'h2',
            'class' => array('element-invisible'),
          ),
        )); ?>
      </nav>
  ...
  <div id="main">
    <div id="content" class="column" role="main">
      ...
      <div class="results"><span
          class="results-for"><?php print t('Results for');
          ?></span><?php print $breadcrumb; ?>
      </div>
